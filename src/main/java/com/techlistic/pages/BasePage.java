...
public class BasePage extends Page{
	...
	public WebElement getWebElement(By locator) {
		...
		try {
			...
			System.out.println("Error occued while finding the element"+locator.toString());
			return null;
		}
	}
	...
	public void waitForWebElementVisibility(By locator) {
		try {
			...
			System.out.println("Exception occured while waiting for the Visibility of WebElement" + locator.toString());
			e.printStackTrace();
		}
	}
